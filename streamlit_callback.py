...
class StreamlitCallbackHandler(BaseCallbackHandler):
    ...
    def on_llm_new_token(self, token: str, **kwargs: Any) -> None:
        ...
        if '<answer>' in self.tokens_stream or '</answer>' in self.tokens_stream:
            self.tokens_stream = self.tokens_stream.replace('<answer>', '').replace('</answer>', '')
